...
namespace FridayCollective\LaravelGmail\Services\Message;
...
use FridayCollective\LaravelGmail\GmailConnection;
use FridayCollective\LaravelGmail\Traits\HasDecodableBody;
use FridayCollective\LaravelGmail\Traits\HasParts;
use FridayCollective\LaravelGmail\Traits\Modifiable;
use FridayCollective\LaravelGmail\Traits\Replyable;

/**
 * Class SingleMessage
 *
 * @package FridayCollective\LaravelGmail\services
 */
class Mail extends GmailConnection
{
    ...
    )
    {
        ...
        $this->__rConstruct();
        $this->__mConstruct();
        parent::__construct(config()['gmail'], $emailIntegrationConfig);
